	...
	<div class="row">
		<div class="col-lg-6"> 
			<div class="page-header">
			  	<h1>Editar Personal <a href="{{ url('admin/personales')}}" class="btn btn-lg btn-default pull-right">{{ trans('admin.cancel') }}</a></h1>
			</div>
            @if($errors->all())
			...
			{{ Form::model($personal,array('class'=>'form-horizontal'))}}
