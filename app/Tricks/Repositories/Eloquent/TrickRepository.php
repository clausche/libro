...
class TrickRepository extends AbstractRepository implements TrickRepositoryInterface
{
     ...
     */
    public function findAllForUser(User $user, $perPage = 6)
    {
     ...
     * @return \Illuminate\Pagination\Paginator|\Tricks\Trick[]
     */
    public function findAllFavorites(User $user, $perPage = 6)
    {
     ...
     * @return \Illuminate\Pagination\Paginator|\Tricks\Trick[]
     */
    public function findAllPaginated($perPage = 6)
    {
     ...
     * @return \Illuminate\Pagination\Paginator|\Tricks\Trick[]
     */
    public function findMostRecent($per_page = 6)
    {
     ...
     * @return \Illuminate\Pagination\Paginator|\Tricks\Trick[]
     */
    public function findMostCommented($perPage = 6)
    {
     ...
     * @return \Illuminate\Pagination\Paginator|\Tricks\Trick[]
     */
    public function findMostPopular($per_page = 6)
    {
        return $this->model
     ...
     * @return array
     */
    public function findByCategory($slug, $perPage = 6)
    {
     ...
     * @return array
     */
    public function listCiudadesIdsForTrick(Trick $trick)
    {
        return $trick->ciudades->lists('id');
    }
     ...
     * @return \Illuminate\Pagination\Paginator|\Tricks\Trick[]
     */
    public function findByTag($slug, $perPage = 6)
    {
     ...
     * @return \Illuminate\Pagination\Paginator|\Tricks\Trick[]
     */
    public function findByCiudad($slug, $perPage = 6)
    {
        $ciudad = $this->ciudad->whereSlug($slug)->first();

        if (is_null($ciudad)) {
            throw new TagNotFoundException('La ciudad "' . $slug . '" no existe!');
        }

        $tricks = $ciudad->tricks()->orderBy('created_at', 'desc')->paginate($perPage);
