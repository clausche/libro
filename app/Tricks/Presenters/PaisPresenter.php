...
class PaisPresenter extends BasePresenter
{
    /**
    ...
    {
        return URL::route('paises.edit', [ $this->resource->slug ]);
    }
    /**
     * Get the edit link for this trick.
     *
    ...
    {
        return URL::route('paises.delete', [ $this->resource->slug ]);
    }
    ...
    {
        $description = $this->resource->district;
        $maxLength   = 160;
