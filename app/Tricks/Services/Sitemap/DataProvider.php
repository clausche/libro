...
class DataProvider
{
    ...
    /**
     * Get all the ciudades to include in the sitemap.
     *
    ...
    /**
     * Get the url for the given ciudad.
     *
     * @param  \Tricks\Ciudad  $ciudad
     * @return string
     */
    public function getCiudadUrl($ciudad)
    {
        return $this->url->route('tricks.browse.ciudad', $ciudad->slug);
    }
